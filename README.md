...
Overview
The PhonePe Pulse Data Visualization project aims to extract data from the PhonePe Pulse GitHub repository, process it to obtain insights and information, and visualize it in a user-friendly manner using Streamlit and Plotly in Python.

Problem Statement
The PhonePe Pulse GitHub repository contains a large amount of data related to various metrics and statistics. The goal is to extract this data, perform necessary cleaning and pre-processing, insert it into a MySQL database, and create an interactive geo visualization dashboard to display the data.

Approach
Data Extraction: Clone the GitHub repository using scripting to fetch the data.
Data Transformation: Pre-process and clean the data using Python and Pandas.
...
Data Retrieval: Fetch data from the MySQL database to dynamically update the dashboard.
Deployment: Ensure the solution is secure, efficient, and user-friendly, and deploy the dashboard publicly.


Results
The result of this project is a live geo visualization dashboard that displays insights from the PhonePe Pulse GitHub repository. The dashboard allows users to select different facts and figures using dropdown options and dynamically updates to reflect the latest data.

Usage
Clone the repository:


git clone https://github.com/your_username/phonepe-pulse-data-viz.git
